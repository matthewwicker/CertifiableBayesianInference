...
#    learning_rate = 0.1; decay=0.0; inf=250
#    used 25 steps 
    learning_rate = 0.025; decay=0.0; inf=20
...
bayes_model = opt.compile(model, loss_fn=loss, epochs=20, learning_rate=learning_rate,
                          ...
                          burn_in=5, steps=25, b_steps=20, epsilon=eps, rob_lam=lam) #, preload="SGD_FCN_Posterior_1")
#steps was 50
